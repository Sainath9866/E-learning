...
export function Sql() {
    ...
    const info = ["1.SQL Databases", "2.Why not NoSql?", "3.Why SQL?", "4.Creating a Database", "5.Using a Library to Connect and Store Data", "6.Creating a Table and Defining its Schema",
        "7.Interacting with Database", "8.How to do queries from a Node.js app?", "9.CReate a simple Node.js App", "10.Relationships and Transactions in MongoDB", "11.Joins"
    ]
